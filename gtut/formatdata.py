...
def writeFormattedData():
    ...
    with open('fake_user_tweet_article.csv', mode='w') as relfile:
        links = csv.writer(relfile, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('fake_tweet_content.json', 'w') as fp:
        json.dump(fake_tweet_content, fp)

    # fake-user-articles file
    with open('fake_user_articles.json', 'w') as fp:
    ...
    with open('real_article_tweetids.json', 'w') as fp:
    ...
    with open('real_user_tweet_article.csv', mode='w') as relfile:
        links = csv.writer(relfile, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('real_tweet_content.json', 'w') as fp:
        json.dump(real_tweet_content, fp)

    # real-user-articles file
    with open('real_user_articles.json', 'w') as fp:
...
def main():
    dataLocation = '../small_dataset/politifact'
    dirList = ["fake", "real"]
